...
module.exports = {
    getConfig: function (server, options) {
        ...
        let routeValidation;
        const routeFailure = _.any(routeSettings, setting => {
            routeValidation = Joi.validate(setting.plugins.pagination, internals.routeSchema);
            return routeValidation.error;
        });
