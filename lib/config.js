...
const internals = {
    ...
    check: function(predicate, message) {
        Hoek.assert(predicate, this.TypeError(message));
    },
    checkConfig: function(config) {
        ...
        this.check(this.isString(config.meta.page.name), 'page name must be a string');

        this.check(this.isBoolean(config.meta.limit.active), 'limit active must be a boolean');
        this.check(this.isString(config.meta.limit.name), 'limit name must be a string');
